...
def parse_args():
    ...
    parser.add_argument('--llm_type', type=str, choices=list(LLMTypes._value2member_map_.keys()), default='openai')
    parser.add_argument('--llm', type=str, choices=list(LLMs._value2member_map_.keys()), default='gpt-3')
